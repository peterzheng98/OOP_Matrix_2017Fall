...
std::pair<bool, std::string> testOperations() {
    ...
    try {
        ...
        if (typeid(f(0, 0)) != typeid(b(0, 0)))
            return WA("*");
        std::initializer_list<std::initializer_list<int>> TimeintIl = {{754, 934, 971, 834, 165, 101, 659, 360, 341, 827, 925, 684, 985, 463, 986, 916, 992, 84,  651, 692, 35,  746, 898, 472, 40,  338, 434, 138, 851, 796, 443, 896, 553, 775, 862, 313, 841, 918, 654, 968, 537, 892, 953, 371, 7,   534, 820, 776, 952, 728, 524, 264, 373, 865, 377, 147, 76,  395, 172, 228, 604, 621, 781, 4,   243, 324, 20,  637, 173, 393, 363, 183, 964, 255, 256, 220, 967, 763, 205, 92,  800, 767, 446, 175, 606, 502, 962, 14,  835, 454, 280, 868, 155, 248, 904, 164, 787, 786, 556, 10},
                                                                       {221, 16,  383, 421, 749, 978, 208, 623, 466, 111, 800, 316, 467, 141, 830, 389, 364, 816, 952, 87,  654, 637, 459, 492, 839, 628, 508, 523, 368, 367, 987, 795, 287, 462, 719, 977, 272, 503, 137, 509, 867, 265, 724, 286, 140, 714, 14,  521, 515, 78,  496, 696, 827, 60,  850, 619, 915, 536, 464, 246, 849, 23,  366, 546, 989, 407, 332, 657, 940, 717, 704, 630, 985, 822, 240, 260, 187, 580, 58,  248, 406, 40,  564, 385, 161, 873, 254, 400, 435, 968, 106, 555, 154, 889, 554, 401, 327, 941, 639, 495},
                                                                       {221, 16,  383, 421, 749, 978, 208, 623, 466, 111, 800, 316, 467, 141, 830, 389, 364, 816, 952, 87,  654, 637, 459, 492, 839, 628, 508, 523, 368, 367, 987, 795, 287, 462, 719, 977, 272, 503, 137, 509, 867, 265, 724, 286, 140, 714, 14,  521, 515, 78,  496, 696, 827, 60,  850, 619, 915, 536, 464, 246, 849, 23,  366, 546, 989, 407, 332, 657, 940, 717, 704, 630, 985, 822, 240, 260, 187, 580, 58,  248, 406, 40,  564, 385, 161, 873, 254, 400, 435, 968, 106, 555, 154, 889, 554, 401, 327, 941, 639, 495},
                                                                       {221, 16,  383, 421, 749, 978, 208, 623, 466, 111, 800, 316, 467, 141, 830, 389, 364, 816, 952, 87,  654, 637, 459, 492, 839, 628, 508, 523, 368, 367, 987, 795, 287, 462, 719, 977, 272, 503, 137, 509, 867, 265, 724, 286, 140, 714, 14,  521, 515, 78,  496, 696, 827, 60,  850, 619, 915, 536, 464, 246, 849, 23,  366, 546, 989, 407, 332, 657, 940, 717, 704, 630, 985, 822, 240, 260, 187, 580, 58,  248, 406, 40,  564, 385, 161, 873, 254, 400, 435, 968, 106, 555, 154, 889, 554, 401, 327, 941, 639, 495},
                                                                       {221, 16,  383, 421, 749, 978, 208, 623, 466, 111, 800, 316, 467, 141, 830, 389, 364, 816, 952, 87,  654, 637, 459, 492, 839, 628, 508, 523, 368, 367, 987, 795, 287, 462, 719, 977, 272, 503, 137, 509, 867, 265, 724, 286, 140, 714, 14,  521, 515, 78,  496, 696, 827, 60,  850, 619, 915, 536, 464, 246, 849, 23,  366, 546, 989, 407, 332, 657, 940, 717, 704, 630, 985, 822, 240, 260, 187, 580, 58,  248, 406, 40,  564, 385, 161, 873, 254, 400, 435, 968, 106, 555, 154, 889, 554, 401, 327, 941, 639, 495},
                                                                       {221, 16,  383, 421, 749, 978, 208, 623, 466, 111, 800, 316, 467, 141, 830, 389, 364, 816, 952, 87,  654, 637, 459, 492, 839, 628, 508, 523, 368, 367, 987, 795, 287, 462, 719, 977, 272, 503, 137, 509, 867, 265, 724, 286, 140, 714, 14,  521, 515, 78,  496, 696, 827, 60,  850, 619, 915, 536, 464, 246, 849, 23,  366, 546, 989, 407, 332, 657, 940, 717, 704, 630, 985, 822, 240, 260, 187, 580, 58,  248, 406, 40,  564, 385, 161, 873, 254, 400, 435, 968, 106, 555, 154, 889, 554, 401, 327, 941, 639, 495},
...
int main() {
    ceTest();
    std::pair<std::string, std::function<std::pair<bool, std::string>(
            void)>> testcases[] = {{"testCtorAssignment", testCtorAssignment},
